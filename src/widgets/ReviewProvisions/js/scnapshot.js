...
class CameraSnapshot {
  ...
  getImgSrc() {
    ...
    var preview = function() {
      ...
      pic_model.innerHTML = '<div><div id="pic_header">图片预览<span id="pic_close">X</span></div><div id="pic_content"><div id="pic_img"></div></div><div id="pic_footer"><button id="pic_delete">删除</button></div></div>';
      basePage.appendChild(pic_model);
      var pic_img2 = document.getElementById("pic_img");
      var img_pre = document.createElement("img");
      img_pre.id = "img_pre";
      img_pre.src = pic_img.src;
      ...
      $('#img_pre').blowup({"background" : "#F39C12","width" : 250,"height" : 250,"scale" : 2.5});
    ...
    pic_img.style.height = "auto"
     ...
     pic_div.addEventListener("mouseover",function(){
       pic_img.classList.add("pic_img_mark");
       look_del.style.display ="block";
     },false);
     pic_div.addEventListener("mouseout",function(){
  ...
  createCanvasUI() {
    ...
    var genimg = canvas2image.Canvas2Image.convertToImage(
      canvas,
      w,
