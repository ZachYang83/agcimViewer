(function () {
	...
	Colorpicker.prototype = {
		init(opt) {
			let { pl, el, initColor = "rgb(255,0,0)", allMode = ['hex', 'rgb'], color = '' } = opt;
			...
			var body = document.getElementById(pl)
				div = document.createElement("div");
			
			div.className = "pickColorPanel";
			...
			util.css(div, {
				...
				"display": 'none',
				"left": 30 + "px",
				"top": 0 + this.bindElem.offsetHeight + "px"
			});
		...
		render: function () {
			var tpl =
				...
				<div style="position: inherit;z-index: 1100;display: flex;box-shadow: rgba(0, 0, 0, 0.3) 0px 0px 2px, rgba(0, 0, 0, 0.3) 0px 4px 8px;">
							...
							<div class="flexbox-fix" style="display: flex;align-items: center;height: 40px;">
								<div style="width: 32px;">
									<div style="width: 16px; height: 16px; border-radius: 8px; position: relative; overflow: hidden;">
										<div class="colorpicker-showColor" style="position: absolute; top: 0px; right: 0px; bottom: 0px; left: 0px; border-radius: 8px; box-shadow: rgba(0, 0, 0, 0.1) 0px 0px 0px 1px inset; background:rgb(${this.rgba.r},${this.rgba.g},${this.rgba.b}); z-index: 1112;"></div>
