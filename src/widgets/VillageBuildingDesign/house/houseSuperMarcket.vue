    ...
    <div v-show="indexModelPanel===1">
      ...
      <div class="do_group">
        ...
        <a-button
          ...
          v-on:click="activeHouseComparedPanel"
          value="small"
          icon="check"
          title="添加房屋"
          v-if="false"
...
import housepanel from "../house/index.vue";
import houseComparedPnel from "../houseCompared/index.vue";

import bin_default from "@/assets/img/house.png";
import projectServer from "@/net/server/projectServer";
...
.bin_select_panel::-webkit-scrollbar {
    /*滚动条整体样式*/
    width: 5px;
    /*高宽分别对应横竖滚动条的尺寸*/
    height: 1px;
  ...
  .bin_select_panel::-webkit-scrollbar-thumb {
    /*滚动条里面小方块*/
    border-radius: 5px;
  ...
  .bin_select_panel::-webkit-scrollbar-track {
    /*滚动条里面轨道*/
    -webkit-box-shadow: inset 0 0 2px #999999;
    border: 0;
    border-radius: 5px;
