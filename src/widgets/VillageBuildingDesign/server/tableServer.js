 ...
 * @LastEditTime: 2021-01-28 14:57:20
...
const tableServer = {
    ...
    findDentityUrl: proxyUrl + `/agsupport/bimParamethy/building/get`,
    findDentityUrll: proxyUrl + `/agsupport/BIM/dentity/find`,
    ...
    findDentityy: async params => {
        return axiosWraper.getData(tableServer.findDentityUrll, params);
    },
