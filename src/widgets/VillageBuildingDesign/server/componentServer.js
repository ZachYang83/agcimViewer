...
let proxyUrl = '/agsupport-data-manager';
...
const componentServer = {
    ...
    findComponent: async params => {
        let url = `/agsupport-rest/BIM/Component/find`;
        return axiosWraper.getData(proxyUrl + url, params);
    },

    previewComponentUrl: proxyUrl + '/agsupport-rest/BIM/Component/preview',
    ...
    previewComponent: async (params = {id}) => {
        ...
        let url = `/agsupport-rest/BIM/Component/preview`;
        return axiosWraper.getData(proxyUrl + url, params);
    },
     ...
     */
    addComponent: params => {
        let url = `/agsupport-rest/BIM/Component/add`;
        return axiosWraper.getDataByPost(proxyUrl + url, params);
    },
}
// http://192.168.3.204:8290/agcloud/agsupport/BIM/Project/preview/null
